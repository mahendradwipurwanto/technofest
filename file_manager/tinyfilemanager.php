...
//Application Title
define('APP_TITLE', 'TechnoFest File Manager | Karya');
...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/berkas/karya';
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            $techno = "<a href='Dashboard' style='margin-right:5px;'><i class='fa fa-desktop' aria-hidden='true' title='Back to dashboard'></i> Kembali ke laman admin</a>";
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'TechnoFest File Manager';      $tr['en']['AppTitle']           = 'TechnoFest File Manager';
