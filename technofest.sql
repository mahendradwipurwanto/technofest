...
--
-- Host: localhost:3306
-- Generation Time: 06 Feb 2021 pada 15.19
...
('USER_d2d92', 'MAIN ADMIN', 'admin@techno.com', '$2y$10$P48TJg9CQd6b5UjCGWGXEuELywsZyzI.qPSHpy11oHpkH7JVv2IPa', 'STIKI Malang', '', 0),
...
INSERT INTO `TB_KARYA` (`ID_KARYA`, `ID_KATEGORI`, `JUDUL`, `DESKRIPSI`, `PRODI`, `DOSPEM`, `LINK_DEMO`, `LINK_VIDEO`, `FOLDER`) VALUES
('-RM_SM9ZU', 'PLK_B5YAC', 'E-RMS RSUD Dr.Iskak', 'Aplikasi pengolahan data rekam medis rumah sakit Dr. Iskak tulung agung', 2, '-', '', '', 'E_RMS_RSUD_Dr_Iskak'),
('BC(_LYAVE', 'PLK_E0KME', 'ABC (Asyiknya Belajar Ceria)', 'Game edukasi anak sebagai sarana belajar mengenal nama hewan, huruf, angka dan suku kata yang dipadukan dengan animasi dan suara yang menarik. Dan pada game ini juga terdapat memori game untuk melatih daya ingat anak.', 2, 'Chaulina Alfianti Oktavia, S.Kom., M.T', '', '', 'ABC__Asyiknya_Belajar_Ceria_'),
('BKN_9X23J', 'DSN_B4PFQ', 'Booking Pendakian Gunung Panderman dan Buthak', '- Informasi tentang pendakian gunung khususnya Panderman dan Buthak hanya lewat sosmed (Instagram) yang tidak jelas siapa pemilik akunnya.\r\n- Jumlah pendaki yang kapasitas nya overload.\r\n- Sulit nya pihak yang berwenang dalam manajemen pendaki.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Booking_Pendakian_Gunung_Panderman_dan_Buthak'),
('BRT_7VSUD', 'PLK_B5YAC', 'BeritaKu', 'Web aplikasi untuk editor berita', 2, 'Sugeng Widodo, S.Kom., M.Kom', '', '', 'BeritaKu'),
('BTT_R00LV', 'PLK_B5YAC', 'Bettabell Web', 'Sebuah web yang berisi pengetahuan tentang betta fish dan koleksi pribadi saya sendiri.', 1, 'Sugeng Widodo, S.Kom., M.Kom', '', '', 'Bettabell_Web'),
('CST_J3ERA', 'PLK_B5YAC', 'Cost Calculator (Hitung Jarak)', 'Sebuah aplikasi berbasis web yang dibangun dengan Plugin Mapbox (mapbox-gl-directions) + Javascript untuk menghitung jarak dan ongkos kirim per kilometer sesuai jarak.', 1, '-', 'https://yogibagus.github.io/hitung-jarak', '', 'Cost_Calculator__Hitung_Jarak_'),
('DHR_I8D8K', 'PLK_B5YAC', 'Dhuar Pesantren', '\"Dhuar Pesantren\" adalah pengembangan website pesantren yang di kembangkan oleh Team Dhuar menggunakan framework Codeigniter serta Bootstrap 4.0, sebagai media informasi pesantren dan juga sebagai media promosi pesantren. ', 2, '-', 'http://istanbul.teamdhuar.com/', '', 'Dhuar_Pesantren'),
('DHR_QFJQB', 'PLK_B5YAC', 'Dhuar SIGFasUmKaltim', 'Dhuar Sistem Informasi Geografis Penyebaran Fasilitas Umum Di Kalimantan Timur adalah pengembangan website Sistem Informasi Geografis yang di kembangkan oleh Team Dhuar menggunakan framework Codeigniter serta Bootstrap 4.0.', 2, 'Subari, S.Kom., M.Kom', 'www.sig.teamdhuar.com', '', 'Dhuar_SIGFasUmKaltim'),
('FLX_UATPG', 'PLK_B5YAC', 'flixRate', 'Web aplikasi untuk memberikan rating pada sebuah film.', 2, 'Sugeng Widodo, S.Kom., M.Kom', '', '', 'flixRate'),
('HTL_YK0QG', 'PLK_B5YAC', 'Hotel edotel SMKN 2', 'Project Website tentang pemesanan dan konfrimasi by admin untuk SMKN 2 malang dan di admin ada Fitur login & CRUD yang dimana admin bisa konfrimasi customer dan update room & stock Room ,Print Data Customer untuk halaman utama di customer bisa login.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Hotel_edotel_SMKN_2'),
('HTN_7OW9Q', 'PLK_B5YAC', 'Hitung Zakat', 'Aplikasi ini bernama aplikasi hitung zakat yaitu kita bisa menghitung jumlah harta dan kewajiban kita bayar yaitu zakat maal dan zakat fitrah. Dengan aplikasi ini mempermudah kita dalam mengetahui kewajiban kita yang harus dibayarkan.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Hitung_Zakat'),
('KTM_DCSHD', 'PLK_B5YAC', 'Ketemu: yet another meeting app', 'Website video conference sederhana berbasis web memanfaatkan api dari jitsi', 2, '-', 'https://ketemu.diwangkara.dev/panjiganteng', '', 'Ketemu:_yet_another_meeting_app'),
('LPL_RYCBD', 'PLK_B5YAC', 'Lapole', 'Sebuah website yang berisi tentang travelling', 1, 'Sugeng Widodo, S.Kom., M.Kom', '', '', 'Lapole'),
('MR(_L136J', 'DSN_B4PFQ', 'MERO ( MEDIC HERO ) ', 'adanya desain MERO (Medic Hero) ini dapat memudahkan masyarakat dalam aktifitas didunia kesehatan.', 1, 'Febry Eka Purwiantono, S.Kom., M.Kom', '', '', 'MERO___MEDIC_HERO___'),
('NVS_4819U', 'PLK_E0KME', 'Invasion Rush', 'Invasion Rush adalah sebuah aplikasi permainan FPS sebagai media hiburan dan pembelajaran pada masa pandemi COVID-19 dengan\r\ntema yang menganalogikan alien virus jahat penginvasi bumi.', 2, 'Arif Tirtana, S.Kom., M.Kom, Mahendra Wibawa, S.Sn', '', '', 'Invasion_Rush'),
('PDM_D12FK', 'PLK_LO9C2', 'PDAM CASHLESS ', 'Penyampaian Keluhan Pribadi terhadap pelayanan yang PDAM berikan yang mungkin kurang maksimal atau yang lainnya.\r\nPembayaran cashless agar mempermudah pelanggan yang mungkin tidak dapat pergi ke kantor PDAM karena satu atau berbagai hal, ', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'PDAM_CASHLESS_'),
('PHT_S8BJG', 'PLK_E0KME', 'PhotoMap', 'Aplikasi pengambilan foto beserta lokasi', 2, '-', '', '', 'PhotoMap'),
('PLK_0AIKO', 'DSN_B4PFQ', 'Aplikasi M-POINT', 'salah satu hal yang dapat meningkatkan semangat belajar mahasiswa terutama yang memasuki semester tua adalah sebuah reward. Aplikasi ini bertujuan menambah benefit mahasiswa ketika mereka mengerjakan tugas,selain mendapatkan nilai,mendapatkan reward.', 4, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_M_POINT'),
('PLK_0D2P0', 'PLK_B5YAC', 'Aplikasi BOKI ', 'Aplikasi berbasis website dengan menggunakan CodeIgniter. Memiliki fitur pengaturan pengeluaran, pemasukan, hutang & piutang, aset, modal, laporan laba rugi, laporan keuangan, dan laporan pajak.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', 'https://boki.my.id/ (username : admin, pass : admin)', 'https://www.youtube.com/watch?v=2m-WCITdbRQ', 'Aplikasi_BOKI_'),
('PLK_3AF5H', 'DSN_B4PFQ', 'Aplikasi Mobile App Malang Explore', 'Mobile aplikasi Malang Explore untuk membantu para pengunjung yang berada di luar kota maupun dalam kota untuk mendapatkan informasi bahkan mem-booking tiket dengan mudah melalui aplikasi ini.', 3, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Mobile_App_Malang_Explore'),
('PLK_3QQ7A', 'PLK_B5YAC', 'Aplikasi Pembukuan Kas Pribadi', 'Aplikasi berfungsi sebagai pembukuan pemasukan dan pengeluaran pribadi agar pembukuan mudah dihitung dan dianalisa.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Pembukuan_Kas_Pribadi'),
('PLK_45N70', 'DSN_B4PFQ', 'Aplikasi Kursus Dan Penjualan Buku Indofira', 'aplikasi ini bertujuan untuk merancang sebuahaplikasi mobile yang dapat membantu pengguna untuk mencari buku maupun kursus secara online. Tidak hanya itu, aplikasi yang dirancang juga mampu untuk melakukan transaksi secara online untuk setiap buku.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Kursus_Dan_Penjualan_Buku_Indofira'),
('PLK_8G1TS', 'PLK_LO9C2', 'Aplikasi Pembelajaran GH-LEARNING', 'Membuat aplikasi pembelajaran yang kami harapkan dapat membantu para\r\nsiswa yang kesulitan dalam proses pembelajaran yang diberikan oleh sekolah.', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Aplikasi_Pembelajaran_GH_LEARNING'),
('PLK_8J6BC', 'DSN_B4PFQ', 'Aplikasi penjualan Jahe', '- Kurangnya platform aplikasi penjualan tanaman herbal (jahe)\r\n- Penjualan meningkat\r\n- Dikenal banyak orang', 3, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_penjualan_Jahe'),
('PLK_93103', 'PLK_LO9C2', 'Aplikasi Klinik Rekam Medis', 'Manfaat dari pembuatan aplikasi ini yaitu :\r\n1) Bagi Klinik\r\na)	Mempermudah saat pencarian dan pengolahan data.\r\nb)	Mempermudah dan menghemat waktu saat pembuatan laporan.\r\nc)	Mengurangi terjadinya duplikasi data.\r\nd)	Meningkatkan kualitas pelayanan.\r\n ', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Aplikasi_Klinik_Rekam_Medis'),
('PLK_95ZWJ', 'DSN_B4PFQ', 'Aplikasi Perpustakaan Online “BukuQT”', 'Aplikasi yang menyediakan layanan ebook secara gratis yang bisa diakses melalui smartphone. Dimana masyarakat nantinya bisa membaca berbagai macam buku yang tersedia kapanpun dan dimananpun.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Perpustakaan_Online_“BukuQT”'),
('PLK_BOW1L', 'DSN_B4PFQ', 'Aplikasi Marketplace Oleh-oleh Khas Daerah', 'Wisatawan tidak tahu oleh-oleh khas daerah yang didatanginya. Terkadang orang ingin membeli oleh-oleh khas daerah lain yang tidak dijual di daerahnya. Sebuah peluang bagi pelaku UMKM untuk melebarkan sayap dengan memasarkan produknya ke daerah lain. ', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Marketplace_Oleh_oleh_Khas_Daerah'),
('PLK_CJMNG', 'PLK_LO9C2', 'Aplikasi E-Canteen', 'Aplikasi atau program yang kami buat ini diharapkan dapat memberikan rasa aman bagi customer (pembeli) disaat mereka ingin pergi untuk membeli / memesan sesuatu di kantin,\r\nsehingga customer hanya perlu datang dan langsung duduk di kursi yang tersedia', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Aplikasi_E_Canteen'),
('PLK_DSLTO', 'PLK_B5YAC', 'Aplikasi KursusLAnguage', 'Web yang dibuat untuk melakukan pendaftaran kursus bahasa di Language.', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Aplikasi_KursusLAnguage'),
('PLK_E0HFX', 'PLK_LO9C2', 'Aplikasi to do list skripsi', 'Fungsi Utama Program ini digunakan untuk manajemen progress pengerjaan skripsi mahasiswa Aplikasi ini dibuat dengan Java Dekstop', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Aplikasi_to_do_list_skripsi'),
('PLK_EPJHC', 'DSN_B4PFQ', 'Aplikasi Tour Travel Bali', 'aplikasi android ini merupakan bentuk penawaran kenyaman bagi konsumen jasa transportasi travel yang tidak perlu lagi menanyakan dan mencatat jadwal keberangkatan dari travel tersebut.Sistem ini dirancang sedemikian rupa untuk calon penumpang.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Tour_Travel_Bali'),
('PLK_F0OK1', 'PLK_LO9C2', 'Aplikasi Jasa titip barang', 'Manfaat dari pembuatan aplikasi ini yaitu :\r\na)	Mempermudah saat pencarian dan pengolahan data jasa titip.\r\nb)	Mempermudah dan menghemat waktu saat pembuatan laporan jasa titip.\r\nc)	Mengurangi terjadinya duplikasi data.\r\nd)	Meningkatkan kualitas pelayana', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Aplikasi_Jasa_titip_barang'),
('PLK_F49AZ', 'DSN_B4PFQ', 'Aplikasi Dhuar Wisata', 'mempermudah pencarian lokasi Destinasi Wisata buat siapa saja yang memerlukan informasi tersebut. Kemudian pencarian lokasi tersebut bisa dijadikan sebagai bahan pertimbangan dalam menentukan rute jalur yang tepat untuk mencapai lokasi fasilitas.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Dhuar_Wisata'),
('PLK_FEYYQ', 'DSN_B4PFQ', 'Aplikasi Pemesanan Tiket Travel Ntap Travel', 'aplikasi yang bertujuan untuk menangani masalah-masalah seperti pemesanan tiket travel dilakukan secara offline dengan menerapkan sistem baru pemesanan secara online dan otomatis.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Pemesanan_Tiket_Travel_Ntap_Travel'),
('PLK_FTG92', 'PLK_B5YAC', 'Aplikasi Kasir', 'Aplikasi kasir ini berfungsi sebagai pencatatan penjualan produk dalam suatu toko.', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Aplikasi_Kasir'),
('PLK_GF9B8', 'DSN_B4PFQ', 'Aplikasi Sistem Informasi Pertanian Hidroponik', 'Karena banyaknya petani hidroponik yang kesulitan untuk mencari informasi seputar pertanian hidroponik dan marketplace yang menjual produk hidroponik, dibuatlah aplikasi platform ini yang dapat mendukung kegiatan tersebut.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Sistem_Informasi_Pertanian_Hidroponik'),
('PLK_GP31B', 'PLK_LO9C2', 'Aplikasi Rental Mobil', 'a) Memberikan kemudahan dalam proses transaksi penyewaan dan pengembalian mobil.\r\n   b) Memberikan informasi bukti penyewaan dan membantu dalam penyimpanan data.\r\n   c) Mempermudah pembukuan\r\n   d) Data lebih mudah di backup', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Aplikasi_Rental_Mobil'),
('PLK_IW5VL', 'DSN_B4PFQ', 'Aplikasi Katalog Perpustakaan', '   Aplikasi ini bertujuan sebagai tools atau alat untuk memudahkan orang yang ingin datang ke perpustakaan tersebut untuk melihat denah dan tata letak buku.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Katalog_Perpustakaan'),
('PLK_K7N8C', 'DSN_B4PFQ', 'Aplikasi Panduan Travelling', 'Aplikasi mobile yang mempermudah menampilkan tujuan wisata, kuliner khas dan penginapan arau hotel dari berbagai kota di Indonesia.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Panduan_Travelling'),
('PLK_MTYN2', 'DSN_B4PFQ', 'Aplikasi Mobile E-learning Untuk Siswa SD', 'Pembelajaran yang sebelumnya dilakukan secara manual melalui tatap muka, kini dapat dilakukan di mana, kapan oleh siapa saja dan oleh berapa banyakjumlah orangnya. Penggunaan teknologi dalam pembelajaran biasa disebut dengan E-Learning.', 4, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Mobile_E_learning_Untuk_Siswa_SD'),
('PLK_MXWJY', 'DSN_B4PFQ', 'Aplikasi Tapak Tilas', 'Aplikasi ini digunakkan untuk memudahkan pengunjung membaca sejarah artefak atau relief tersebut dengan hanya memindai barcode yang dipajang di depan artefak atau relief tersebut yang sebelum nya berupa papan berisi tulisan sejarah yang cukup panjang', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Tapak_Tilas'),
('PLK_N5GX9', 'DSN_B4PFQ', 'Aplikasi Edukasi Anak', 'Aplikasi edukasi anak adalah aplikasi yang memberi pengetahuan terhadap anak mengenai benda” \r\nyang sering kita jumpai seperti sayur, binatang dan buah yang ber basis game. ', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Edukasi_Anak'),
('PLK_NH4MZ', 'DSN_B4PFQ', 'Aplikasi Informasi Lingkungan Sekitar (SPHERE)', 'Banyak pekerja yang pekerjaannya diluar ruangan kesulitan dengan cuaca yang tidak menentu. Kondisi sungai yang dangkal dan mudah banjir, dibutuhkan suatu alat untuk memantau ketinggian agar penduduk sekitar bisa bersiap - siap jika banjir akan datang', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Informasi_Lingkungan_Sekitar__SPHERE_'),
('PLK_Q3PMC', 'DSN_B4PFQ', 'Aplikasi Travelling Guide & Blog DULIN', 'Aplikasi Dulin hadir sebagai solusi untuk menjembatani masalah dibalik berkembangnya bidang pariwisata dan ekonomi kreatif di Indonesia.', 4, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Travelling_Guide___Blog_DULIN'),
('PLK_R849P', 'PLK_LO9C2', 'Aplikasi Manajement Skripsi', 'Manfaat:\r\n• Membantu Dosen dalam memantau dan mengontrol mahasiswa dalam membuat skripsinya.\r\n• Membantu Mahasiswa dalam membuat dan berkonsultasi kepada dosen dalam progress membuat skripsinya.', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Aplikasi_Manajement_Skripsi'),
('PLK_S5ZQF', 'DSN_B4PFQ', 'Aplikasi Poty Hydro', 'aplikasi yang membantu anda mewujudkan budidaya tanaman secara hidroponik secara praktis dan otomatis. Poty memiliki sistem budidaya hidroponik yang berkualitas dan terintegrasi secara otomatis.', 3, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Poty_Hydro'),
('PLK_SMYAT', 'DSN_B4PFQ', 'Aplikasi Pencarian Bengkel (Gobengkel)', 'Aplikasi Gobengkel ini adalah dari permasalah wisatawan yang mana ketika melalukan perjalanan\r\nsecara mandiri dan menggunakan kendaraan pribadi baik itu motor atau mobil sering kali di tengah perjalanan motor atau mobilnya mengalami masalah.', 3, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Pencarian_Bengkel__Gobengkel_'),
('PLK_TBXZD', 'DSN_B4PFQ', 'Aplikasi Simple Smart Daring (SSD)', 'Aplikasi ini dibuat se-Simple mungkin guna membantu para peserta pelatihan yang masih banyak/kurang memahami mengenai teknologi komputerisasi terutama bagi peserta yang sudah berusia lanjut, mereka sering kesulitan dengan sistem daring saat ini.', 4, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Simple_Smart_Daring__SSD_'),
('PLK_U91D6', 'PLK_B5YAC', 'Aplikasi Web Perpustakaan SMA Shalahuddin', 'Aplikasi untuk mencatat data anggota serta histori peminjaman dan pengembalian yang ada di dalam perpustakaan.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Web_Perpustakaan_SMA_Shalahuddin'),
('PLK_WPOQR', 'DSN_B4PFQ', 'Aplikasi Pencarian Guru Les Privat “EduOne”', 'a. Terdapat kesulitan guru privat dalam mencari dan memasarkan layanannya. b. Pencarian guru les privat yang memakan waktu cukup lama, umumnya pencarian guru lesprivat dilakukan melalui kontak rekan profesi, rekomendasi pengguna jasa les sebelumnya', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Pencarian_Guru_Les_Privat_“EduOne”'),
('PLK_XQ7WY', 'DSN_B4PFQ', 'Aplikasi E-learning', 'project yang dirancang ini sebagai e-learning yang dapat membantu memutus penyebaran Covid-19 serta menjaga kesehatan keselamatan jiwa guru dan siswa.', 4, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_E_learning'),
('PLK_Y3AOO', 'PLK_LO9C2', 'Aplikasi Penjualan Toko Komputer ', 'membuat Sistem Aplikasi Penjualan pada sebuah toko komputer yang dapat mengatasi ketidakcocokan antara jumlah penjualan dengan uang yang didapat serta penghematan waktu dan tenaga jika dibandingkan dengan harus mengisi buku penjualan secara manual.', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Aplikasi_Penjualan_Toko_Komputer_'),
('PLK_Z49FM', 'DSN_B4PFQ', 'Aplikasi Pencarian Event Sekolah Annonce.', 'Masih banyak sekali sekolah-sekolah yang mengumumkan kegiatan sekolah baik secara akademik maupun non-akademik melalui surat-menyurat. Bila ada kegiatan yang harus dibayar, masih banyak sekali sekolah-sekolah yang melakukan pembayaran tersebut manual', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Pencarian_Event_Sekolah_Annonce_'),
('PLK_ZDIU8', 'DSN_B4PFQ', 'Aplikasi Pendukung Ternak Ayam', 'aplikasi ini bertujuan sebagai pendukung bagi para peternak sekaligus menjadi mitra bisnis dalam bidang peternakan ayam.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Aplikasi_Pendukung_Ternak_Ayam'),
('PLM_BHX33', 'PLK_B5YAC', 'Plamil - Planner makanan selama 1 minggu', 'Aplikasi planner makanan selama 1 minggu ini digunakkan untuk membantu pengguna atau orang-orang untuk merencanakan menu makan selama 1 minggu kedepan yang bisa juga difilter bila pengguna memiliki kebutuhan khusus seperti alergi.', 1, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Plamil___Planner_makanan_selama_1_minggu'),
('PML_T7IZU', 'PLK_LO9C2', 'Pemilihan Berbasis E-Voting ', 'Dengan adanya aplikasi e – voting ini, diharapkan proses pemilu dapat terjadi dengan efektif dan efisien. Bertujuan menyelenggarakan pemungutan suara dengan biaya hemat dan penghitungan suara yang cepat dengan menggunakan sistem yang aman dan mudah.', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Pemilihan_Berbasis_E_Voting_'),
('PNG_V02TS', 'PLK_B5YAC', 'PENGEMBANGAN SISTEM INFORMASI MANAJEMEN RENCANA...', 'Aplikasi Sistem Informasi untuk mendukung manajemen ketercapaian Rencana Operasional yang terintegrasi dengan data yang ada di STIKI Malang serta dengan Google Drive sebagai tempat penyimpanan filenya. ', 1, 'Koko Wahyu Prasetyo, S.Kom, M.TI', '', '', 'PENGEMBANGAN_SISTEM_INFORMASI_MANAJEMEN_RENCANA___'),
('PNT_HGBLB', 'PLK_LO9C2', 'Point of Sales at Polopendem', '•	Memberi efisiensi waktu\r\n•	Kemudahan mencatat penjualan\r\n•	Pengoperasian POS yang mudah karena UI nya yang friendly\r\n•	Memberi data penjualan terpisah sehingga data penjualan antara angkringan dan restoran dapat dibedakan. ', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Point_of_Sales_at_Polopendem'),
('PRP_26YDK', 'PLK_LO9C2', 'Perpustakaan SMA SHALAHUDDIN MALANG', 'aplikasi sistem informasi yang memadai, untuk memproses peminjam, pengembalian, dan laporan dan menghasilkan informasi yang cepat dan tepat. Aplikasi ini membantu proses peminjaman, pengembalian, serta membantu mempercepat proses pembuatan laporan.', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Perpustakaan_SMA_SHALAHUDDIN_MALANG'),
('PZZ_VFIGS', 'PLK_E0KME', 'Puzzle Game with Unreal Engine', 'Game Puzzle ini adalah aplikasi game Android yang sudah meluncur Alpha Test di Play Store untuk mendapatkan aplikasi dan mencari Bug. ', 2, '-', 'https://youtu.be/evJGIPaNp40', 'https://youtu.be/evJGIPaNp40', 'Puzzle_Game_with_Unreal_Engine'),
('RPL_ZQ6L7', 'PLK_B5YAC', 'Replica We Work Remotely', 'Berupa CRUD Web untuk mencari pekerjaan secara remote. Dan untuk pemberi kerja sebagai tempat untuk menawarkan / Post lowongan pekerjaan secara remote.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Replica_We_Work_Remotely'),
('SKR_ZSJKH', 'PLK_B5YAC', 'Skrining Mandiri COVID-19', 'bertujuan untuk melakukan deteksi dini terhadap masyarakat guna mengidentifikasi populasi yang diharuskan untuk menentukan ada atau tidaknya gejala dari COVID-19.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Skrining_Mandiri_COVID_19'),
('SMB_CGI59', 'PLK_B5YAC', 'Sambat Online', 'Website yang saya buat yaitu website pengaduan layanan online yang digunakan untuk pengaduan masyarakat yang penting bagi pemerintah untuk melihat seberapa besar keberhasilan dalam melaksanakan kegiatan.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Sambat_Online'),
('SMP_SS9U2', 'PLK_B5YAC', 'Simple Theme', 'Sebuah website yang berisi konten seputar berita teknologi di Indonesia.', 1, 'Sugeng Widodo, S.Kom., M.Kom', '', '', 'Simple_Theme'),
('SST_8FAZI', 'PLK_B5YAC', 'Sistem Pemesanan Tiket Travel (Kelana Indonesia)', 'Aplikasi untuk pemesanan tiket travel dari PT. Kelana Indonesia, Dapat mempermudah admin melakukan pencatatan pemesanan, pembuatan jadwal, Manager untuk mengkonfirmasi pembayaran,Driver melihat detail pemesan tiket travel.', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Sistem_Pemesanan_Tiket_Travel__Kelana_Indonesia_'),
('SST_8FQ92', 'PLK_B5YAC', 'Sistem Informasi dan Manajemen Hotel The Seminyak', 'memiliki 2 sudut pandang, yaitu user dan admin. user dapat melakukan reservasi kamar, memberikan kritik saran dan melihat isi website. Kemudian untuk beralih kepada sudut admin, harus melakukan login. ', 1, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Sistem_Informasi_dan_Manajemen_Hotel_The_Seminyak'),
('SST_EKLJI', 'PLK_B5YAC', 'Sistem Informasi Keuangan PPTIK STIKI Malang', '-', 2, 'Meivi Kartikasari, S.Kom, M.T', '', '', 'Sistem_Informasi_Keuangan_PPTIK_STIKI_Malang'),
('STK_UJX35', 'PLK_LO9C2', 'STIKI Cashless Online Canteen', 'Tujuannya :\r\na)	Membantu Pemerintah dalam pencegahan Covid-19 \r\nb)	Mengurangi adanya kontak langsung saat pembelian makanan atau minuman di kantin\r\nc)	Mengurangi adanya kesalahan pembayaran', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'STIKI_Cashless_Online_Canteen'),
('THS_77AQP', 'PLK_B5YAC', 'Thesis Monitoring', 'Fungsi Utama Program ini digunakan untuk memonitoring skripsi mahasiswa, dalam program ini terdapat 2 level User yaitu Mahasiswa dan Dosen User dengan level mahasiswa dapat membuat todolist, jadwal konsultasi, monitoring progress skripsi', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Thesis_Monitoring'),
('TKB_QV1B7', 'PLK_B5YAC', 'Toko Buku', 'Fitur Member : Register, Login, Deposit, Pembelian, Riwayat transaksi. Fitur Admin : Manajemen Produk(tambah,hapus,dan edit), Manajemen transaksi(terima,tolak,refund), Management user(tambah,hapus,dan edit).', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Toko_Buku'),
('TMT_COXJH', 'PLK_B5YAC', 'OTOMOTIF Site', 'pada laman OTOMOTIF Site terdapat berbagai keterangan tentang mobil-mobil sport, berbagai inovasi terobosan baru dari dunia otomotif terkini dan trend-trend yang menjadi minat di kalangan penghobi otomotif.', 1, '-', '', '', 'OTOMOTIF_Site'),
('TRC_02PYU', 'PLK_B5YAC', 'Tracer study', 'Sebuah aplikasi yang digunakan untuk mendata alumni perguruan tinggi. Pada aplikasi ini juga terdapat info berita dan lowongan kerja yang diunggah oleh pihak yang berwenang, dalam aplikasi ini dibatasi hanya pihak universitas dan fakultas.', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Tracer_study'),
('VNT_2457M', 'PLK_B5YAC', 'Event Stiki', 'Event Stiki adalah aplikasi web pengajuan proposal kegiatan yang diajukan oleh mahasiswa saat mengadakan kegiatan di area kampus.', 2, 'Hilman Nuril Hadi, S.Kom., M.Kom', '', '', 'Event_Stiki'),
('WBD_NRVCJ', 'PLK_B5YAC', 'Web Dewan Kesenian Malang', 'web Dewan Kesenian Malang yang menampilkan berita acara, informasi kegiatan DKM, dan Kritik dan saran pengguna terhadap Dewan Kesenian Malang.', 1, 'Sugeng Widodo, S.Kom., M.Kom', '', '', 'Web_Dewan_Kesenian_Malang'),
('WBG_O7GD1', 'PLK_B5YAC', ' Web Game Wild Rift', 'Sebuah web yang menjelaskan game mobile LOL Wild Rift tentang update terbaru dan event terbaru di game tersebut.', 1, 'Sugeng Widodo, S.Kom., M.Kom', '', '', '_Web_Game_Wild_Rift'),
('WBN_1B3V1', 'PLK_B5YAC', 'Web Anime', 'Mengenalkan Anime-anime yang cukup terkenal dimasanya, serta pengumuman mengenai jadwal anime yang akan tayang pada musim selanjutnya.', 1, 'Sugeng Widodo, S.Kom., M.Kom', '', '', 'Web_Anime'),
('WBP_9GGRT', 'PLK_B5YAC', 'Web Perumahan Citra Raya', 'website untuk menampilkan berbagai bentuk dan tipe rumah\r\n', 1, 'Sugeng Widodo, S.Kom., M.Kom', '', '', 'Web_Perumahan_Citra_Raya'),
('WBS_2SDZN', 'PLK_B5YAC', 'Website Sistem Informasi Perpustakaan', 'Aplikasi web ini memiliki fitur login admin/petugas dan manajemen pengelolaan perpustakaan seperti biasa namun lebih terintegrasi dengan database serta dapat diakses online melalui internet.', 1, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', '', 'Website_Sistem_Informasi_Perpustakaan'),
('WBS_6D98K', 'PLK_B5YAC', 'Website EARSIP', 'Website ini menjual produk sistem informasi pengarsipan untuk kantor atau perusahaan-perusahaan yang membutuhkan dengan paket paket yang telah ditentukan.', 2, 'Chaulina Alfianti, S.Kom.,MT', 'www.earsip.xyz', '', 'Website_EARSIP'),
('WBS_FH4B9', 'PLK_B5YAC', 'Website Profile Bina Taqwa', 'website yang ditujukan untuk Pondok Pesantren Bina Taqwa yang berisi tentang informasi dari pesantren Bina Taqwa yang berguna untuk meningkatkan kredibilitas dan agar dapat dikenal di tengah gelombang internet.', 2, 'Adnan Zulkarnain, S.Kom., M.M.S.I', '', 'https://www.youtube.com/watch?v=SUwyAUmynsA', 'Website_Profile_Bina_Taqwa'),
('WBS_H4QBG', 'PLK_B5YAC', 'Website informasi game MLBB', 'Bentuk permainan terstruktur, biasanya dilakukan untuk hiburan atau kesenangan, bisa juga sebagai alat pendidikan.', 1, 'Sugeng widodo, S Kom, M Kom', '', '', 'Website_informasi_game_MLBB'),
('WBS_INH31', 'PLK_B5YAC', 'Web STIKI', 'web STIKI yang menampilkan berita, pengumuman seminar dan informasi-informasi tentang STIKI.', 1, 'Sugeng Widodo, S.Kom., M.Kom', '', '', 'Web_STIKI'),
('WBS_LW1G3', 'PLK_B5YAC', 'Web Serial Animasi', 'website untuk menampilkan berbagai macam serial animasi', 1, 'Sugeng Widodo, S.Kom., M.Kom', '', '', 'Web_Serial_Animasi'),
('WBS_VWBGC', 'PLK_B5YAC', 'Website Mebel Agam Jaya Furniture ', 'Website yang dapat digunakan untuk melihat katalog produk dan juga memesan produk tersebut melalui Whatsapp. ', 2, '-', 'https://agam-jaya.web.app/', '', 'Website_Mebel_Agam_Jaya_Furniture_');
...
('DSN_B4PFQ', 'Desain Prototype UIUX', ''),
('PLK_B5YAC', 'Aplikasi Website', ''),
('PLK_E0KME', 'Aplikasi Mobile', ''),
('PLK_LO9C2', 'Aplikasi Desktop', '');
...
--
ALTER TABLE `TB_AUTHOR`
  MODIFY `ID_AUTHOR` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=271;
--
-- AUTO_INCREMENT for table `TB_FOTO`
--
ALTER TABLE `TB_FOTO`
  MODIFY `ID_FOTO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=386;
--
