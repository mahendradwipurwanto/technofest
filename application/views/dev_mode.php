            ...
            <div class="col-lg-6">
              <div class="mt-5">
                <div class="text-center mt-5">
                  <img class="img-fluid p-2 mt-5" src="<?php echo base_url();?>assets/backend/img/freepik/at-work-pana.svg" alt />
                  <p class="lead">Website kami sedang dalam pengembangan, nantikan nanti!</p>
                  <a class="text-arrow-icon" href="<?php echo site_url('Masuk');?>">
                    <i class="ml-0 mr-1" data-feather="arrow-left"></i>
                    Bagian dari <i class="ml-1">dev team</i>? Masuk sekarang!
                  </a>
                </div>
              </div>
            </div>
