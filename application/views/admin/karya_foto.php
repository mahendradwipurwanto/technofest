    ...
    <form action="<?php echo site_url('Karya/Upload');?>" method="POST" enctype="multipart/form-data">
      ...
      <div class="card shadow-sm">
        <div class="card-header">
          Isi data karya
          <a href="<?php echo site_url('UploadKarya');?>" class="btn btn-warning btn-sm float-right">Kembali</a>
              ...
              <div id="field">
                <fieldset class="scheduler-border">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="NRP[]" maxlength="50" placeholder="Nama anggota" required>
                  </div>
                </fieldset>
              </div>
