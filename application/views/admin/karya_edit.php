                ...
                <div class="row mb-0 mt-0">
                  <div class="col-md-12">
                    <div class="input-group col-xs-12">
                      <a href="<?php echo site_url('Karya/EditFoto/'.$karya->ID_KARYA);?>" target="_blank" class="btn btn-sm btn-info">Ubah foto karya ini?</a> <small class="text-danger ml-1 mt-2">Perbaikan</small>
                    </div>
                  </div>
                </div>
