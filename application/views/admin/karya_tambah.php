...
<div class="row">
  <div class="col-md-12">
    <form action="<?php echo site_url('Karya/Upload');?>" method="POST" onsubmit="show_slow_warning()" enctype="multipart/form-data">
                ...
                <div class="row mb-0 mt-0">
                  <div class="col-md-12">
                    <div class="input-group col-xs-12">
                      <input type="file" class="form-control" name="FOTO[]" multiple placeholder="Upload Image" id="files" onchange="checkFiles(this.files)" required>
                    </div>
                  </div>
                </div>
                <small class="text-danger">WAJIB tambahkan poster anda sesuai template dipanduan. Max size 2mb, max file 5 file</small>
              </div>
              <div class="form-group">
